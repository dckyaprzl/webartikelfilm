...
<!-- cek apakah sudah login -->
	...
	<br/><div class="container mt-3 shadow p-3 mb-5 bg-body-tertiary rounded">
  	<form method="GET" action="upcomingmovie.php"class="d-flex">
  ...
  <?php if(isset($_GET['search'])): ?>
      <a href="upcomingmovie.php" class="btn btn-danger ml-2">X</a>
    <?php endif; ?>
</form>
</div>
...
<br>
	...
	<a href="upcomingtambah.php"type="button" class="btn btn-success">+ TAMBAH JUDUL</a>
	<br/>
...
include 'koneksi.php';
    ...
    $query = "SELECT * FROM upcoming, jenis_genre
              WHERE upcoming.ID_Genre = jenis_genre.ID_Genre
...
$data = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
		...
		while($d = mysqli_fetch_array($data)){
         ...
         <td><img src="file/<?php echo $d['thumbnail']; ?>" alt="Thumbnail" style="max-width: 100px; max-height: 100px;"></td>
				...
				<td>
					<a href="upcomingedit.php?Kode_Film=<?php echo $d['Kode_Film']; ?>"type="button" class="btn btn-warning">EDIT</a>
					<a href="upcoming_hapus.php?Kode_Film=<?php echo $d['Kode_Film']; ?>"type="button" class="btn btn-danger">HAPUS</a>
				</td>
		</tr>
...
<a href="upcoming_cetak.php" target="_blank" class="btn btn-dark">CETAK</a>
</html>
	</table>
</div>
