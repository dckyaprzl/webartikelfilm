...
<body>
    ...
    <div class="container mt-5">
     <a href="top_rated.php" class="btn btn-secondary">BACK</a>
        <div class="row justify-content-center">
            <div class="col-md-8 mt-5">
                ...
                $data = mysqli_query($koneksi, "SELECT * FROM top_rated WHERE Kode_Film='$Kode_Film'");
                ...
                <form method="post" action="tr_update.php">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="Rating" value="<?php echo $d['Rating']; ?>">
                    </div>
                    <div class="mb-3">
