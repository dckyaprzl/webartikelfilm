...
<!-- cek apakah sudah login -->
	...
	<br/><div class="container mt-3 shadow p-3 mb-5 bg-body-tertiary rounded">
  	<form method="GET" action="top_rated.php"class="d-flex">
  ...
  <?php if(isset($_GET['search'])): ?>
      <a href="top_rated.php" class="btn btn-danger ml-2">X</a>
    <?php endif; ?>
</form>
</div>
...
<br>
	...
	<a href="tr_tambah.php"type="button" class="btn btn-success">+ TAMBAH JUDUL</a>
	<br/>
	<br>
...
include 'koneksi.php';
    ...
    $query = "SELECT * FROM top_rated, jenis_genre
...
$data = mysqli_query($koneksi, $query) or die(mysqli_error($koneksi));
		...
		while($d = mysqli_fetch_array($data)){
         ...
         <td><img src="file/<?php echo $d['thumbnail']; ?>" alt="Thumbnail" style="max-width: 100px; max-height: 100px;"></td>
				...
				<td>
					<a href="tr_edit.php?Kode_Film=<?php echo $d['Kode_Film']; ?>"type="button" class="btn btn-warning">EDIT</a>
					<a href="tr_hapus.php?Kode_Film=<?php echo $d['Kode_Film']; ?>"type="button" class="btn btn-danger">HAPUS</a>
				</td>
		</tr>
...
<a href="tr_cetak.php" target="_blank" class="btn btn-dark">CETAK</a>
</html>
	</table>
</div>
