...
<h2>Tambah Kategori</h2>
	<br/>
	<a href="tambah_kategori.php"type="button" class="btn btn-success">+ TAMBAH GENRE</a>
	<br/>
	<br/>
	<table class="table table-striped table-hover">
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
					<a href="edit2.php?ID_Genre=<?php echo $d['ID_Genre']; ?>"type="button" class="btn btn-warning">EDIT</a>
					<a href="hapus2.php?ID_Genre=<?php echo $d['ID_Genre']; ?>"type="button" class="btn btn-danger">HAPUS</a>
				</td>
